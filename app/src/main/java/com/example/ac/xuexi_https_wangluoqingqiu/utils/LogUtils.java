...
public final class LogUtils {
    ...
    // TODO 日志打印开关，和是否输出到文件开关，商用注意关闭！！！
//    private static boolean isLog = BuildConfig.DEBUG;
    private static boolean isLog = true;
//    private static boolean isSaveToFile = BuildConfig.DEBUG;
    ...
    public static void setIsSaveToFile(boolean isSaveToFile) {
       LogUtils.isSaveToFile = isSaveToFile;
    }
    ...
    private static void print2File(final String tag, final String msg) {
        ...
        final String fullPath = (CONFIG.mDir == null ? CONFIG.mDefaultDir : CONFIG.mDir)
